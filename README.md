...
```html
<link href="//cdn.jsdelivr.net/npm/webc.site@0.1.29/Scroll.css" rel="stylesheet">
<script type="module">
  import "//cdn.jsdelivr.net/npm/webc.site@0.1.29/Scroll.js";
</script>
```
...
```html
<link href="//registry.npmmirror.com/webc.site/0.1.29/files/Scroll.css" rel="stylesheet">
<script type="module">
  import "//registry.npmmirror.com/webc.site/0.1.29/files/Scroll.js";
</script>
```
...
```html
<link href="//cdn.jsdelivr.net/npm/webc.site@0.1.29/_Scroll.css" rel="stylesheet">
```
...
```html
<link href="//cdn.jsdelivr.net/npm/webc.site@0.1.29/reset.css" rel="stylesheet">
```

##### npmmirror (中国大陆镜像)

```html
<link href="//registry.npmmirror.com/webc.site/0.1.29/files/reset.css" rel="stylesheet">
```
