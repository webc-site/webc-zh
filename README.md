...
```html
<link href="//cdn.jsdelivr.net/npm/webc.site@0.1.31/Scroll.css" rel="stylesheet">
<script type="module">
  import "//cdn.jsdelivr.net/npm/webc.site@0.1.31/Scroll.js";
</script>
```
...
```html
<link href="//registry.npmmirror.com/webc.site/0.1.31/files/Scroll.css" rel="stylesheet">
<script type="module">
  import "//registry.npmmirror.com/webc.site/0.1.31/files/Scroll.js";
</script>
```
...
```html
<link href="//cdn.jsdelivr.net/npm/webc.site@0.1.31/_Scroll.css" rel="stylesheet">
```
...
```html
<link href="//cdn.jsdelivr.net/npm/webc.site@0.1.31/reset.css" rel="stylesheet">
```

##### npmmirror (中国大陆镜像)

```html
<link href="//registry.npmmirror.com/webc.site/0.1.31/files/reset.css" rel="stylesheet">
```
