...
export default (comp_name, root, is_build) => {
  const comp_dir = join(root, "com", comp_name),
    ...
    entry_content =
      'import "virtual:svgVar.css";import{mount}from"svelte";import Component from"./Demo.svelte";import{B}from"x/dom.js";mount(Component,{target:B});import "x/rmWait.js"';
