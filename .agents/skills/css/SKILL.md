...
10. 重复 8 - 9 ，确保没问题
11. 在项目 /demo/ 文件夹下，创建 `_.htm` `_.css`文件，构建 jsfiddle 上给用户演示如何使用的代码。
    注意:
...
14. 如果要在项目中全局导入，请在 page/entry/init.js 中 import lib/项目名.js ，如果只是单个页面需要用，请在 page项目相关的svelte文件中import "lib/项目名.js" ，运行 ./com.js 会基于 com/ 文件夹打包生成 lib文件夹的可引用组件
